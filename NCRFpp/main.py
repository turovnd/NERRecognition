...
if __name__ == '__main__':
    ...
    parser.add_argument('--custom',  help='Custom adding --train --dev --dev --model_dir --word_feature --char_feature', default='None')
    ...
    parser.add_argument('--raw', default="data/dataset.bmes")
    parser.add_argument('--loadmodel', default="data/models/lstmlstm.0.model")
    parser.add_argument('--output', default="data/results/output.txt")

    parser.add_argument('--model_dir', default="data/models")
    parser.add_argument('--word_feature', default="LSTM")
    parser.add_argument('--char_feature', default="LSTM")
