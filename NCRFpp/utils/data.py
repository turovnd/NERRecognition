...
class Data:
    ...
    def read_custom_data(self, args):
        if args.model_dir:
            self.model_dir = args.model_dir
        if args.word_feature:
            self.word_feature_extractor = args.word_feature
        if args.char_feature:
            self.char_feature_extractor = args.char_feature
        if args.test:
            self.test_dir = args.test
        if args.raw:
            self.raw_dir = args.raw
        if args.loadmodel:
            self.load_model_dir = args.loadmodel
        if args.output:
            self.decode_dir = args.output
        if args.savedset:
            self.dset_dir = args.savedset
