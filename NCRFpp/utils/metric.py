...
def get_ner_fmeasure(golden_lists, predict_lists, label_type="BMES"):
    ...
    print("precision = ", precision, " recall = ", recall, " right_num(TP) = ", right_num, " predict_num(TP+FP) = ", predict_num, " golden_num(TP+FN) = ", golden_num)
    print("TP = ", right_num, " FP = ", predict_num - right_num, " FN = ", golden_num - right_num)
